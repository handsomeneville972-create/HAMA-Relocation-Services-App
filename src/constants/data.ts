...
export const MOCK_COMMUNITY_POSTS: CommunityPost[] = [
  { id: 'c1', user: MOCK_USERS[0], type: 'photo', content: 'Just finished setting up my new living room! The L-shaped sofa from Urban Nest is absolutely stunning. Love how it turned out!', image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600', likes: 245, comments: 34, shares: 12, bookmarks: 56, views: 1284, isLiked: false, isBookmarked: false, createdAt: '2024-06-15T10:30:00Z', tags: ['interiordesign', 'homesetup', 'furniture'] },
  { id: 'c2', user: MOCK_USERS[2], type: 'tip', content: 'Pro tip: Always check the water pressure before renting a house. Low pressure can be a nightmare! Here\'s how to test it with a simple bottle method.', likes: 567, comments: 89, shares: 234, bookmarks: 178, views: 3420, isLiked: false, isBookmarked: false, createdAt: '2024-06-14T15:45:00Z', tags: ['housingtips', 'renting', 'diytips'] },
  { id: 'c3', user: MOCK_USERS[1], type: 'video', content: 'Neighborhood tour of Westlands, Nairobi - the ultimate guide for young professionals looking to relocate!', video: 'https://www.w3schools.com/html/mov_bbb.mp4', likes: 892, comments: 145, shares: 67, bookmarks: 234, views: 5210, isLiked: true, isBookmarked: false, createdAt: '2024-06-13T09:20:00Z', tags: ['neighborhoodguide', 'nairobi', 'relocation'] },
  { id: 'c4', user: MOCK_USERS[4], type: 'experience', content: 'My experience moving from Kisumu to Nairobi for work. The Hamisha Squad made it so easy! Here\'s everything you need to know about relocating.', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600', likes: 423, comments: 67, shares: 89, bookmarks: 145, views: 2310, isLiked: false, isBookmarked: true, createdAt: '2024-06-12T14:00:00Z', tags: ['relocation', 'experience', 'hamishasquad'] },
  { id: 'c5', user: MOCK_USERS[5], type: 'review', content: 'Just reviewed my neighborhood in Kilimani. Overall rating: 4.5/5 - Great security, excellent amenities, and fantastic restaurants nearby!', image: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600', likes: 178, comments: 45, shares: 23, bookmarks: 67, views: 987, isLiked: false, isBookmarked: false, createdAt: '2024-06-11T11:15:00Z', tags: ['neighborhoodreview', 'kilimani', 'nairobi'] },
  { id: 'c6', user: MOCK_USERS[3], type: 'advice', content: 'Student housing tips: 5 things I wish I knew before renting near the university. Save money and avoid common mistakes!', likes: 678, comments: 156, shares: 345, bookmarks: 267, views: 4100, isLiked: true, isBookmarked: true, createdAt: '2024-06-10T08:30:00Z', tags: ['studenthousing', 'tips', 'university'] },
];
...
export const MOCK_PROPERTIES: Property[] = [
  ...
  { id: 'pr5', title: 'Luxury Villa in Karen', description: 'Stunning 5-bedroom villa with private pool, landscaped garden, and staff quarters. Premium security with CCTV.', price: 250000, images: ['https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600', 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600'], bedrooms: 5, bathrooms: 4, size: 350, location: 'Karen, Nairobi', landlord: MOCK_LANDLORD, rating: 4.9, reviewCount: 12, amenities: ['Pool', 'Garden', 'CCTV', 'Generator', 'Parking', 'Servant Quarters'], furnished: true, available: true },
  { id: 'pr6', title: 'Modern Studio in Westlands', description: 'Sleek studio apartment in the heart of Westlands. Walking distance to shopping and nightlife.', price: 18000, images: ['https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=600'], bedrooms: 0, bathrooms: 1, size: 30, location: 'Westlands, Nairobi', landlord: MOCK_LANDLORD, rating: 4.3, reviewCount: 22, amenities: ['WiFi', 'Security', 'Water'], furnished: true, available: true },
  { id: 'pr7', title: 'Family Maisonette in Kiambu Road', description: 'Spacious 4-bedroom maisonette with separate dining, family room, and large compound. Perfect for families.', price: 95000, images: ['https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600', 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=600'], bedrooms: 4, bathrooms: 3, size: 200, location: 'Kiambu Road, Nairobi', landlord: MOCK_LANDLORD, rating: 4.7, reviewCount: 31, amenities: ['Parking', 'Garden', 'Security', 'Water Tank', 'Generator'], furnished: false, available: true },
  { id: 'pr8', title: 'Office Space in CBD', description: 'Professional office space in Nairobi CBD. Suitable for startups and small teams. Furnished with modern amenities.', price: 65000, images: ['https://images.unsplash.com/photo-1497366216548-37526070297c?w=600', 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=600'], bedrooms: 0, bathrooms: 2, size: 120, location: 'CBD, Nairobi', landlord: MOCK_LANDLORD, rating: 4.5, reviewCount: 18, amenities: ['WiFi', 'Air Conditioning', 'Security', 'Parking', 'Reception'], furnished: true, available: true },
];
...
export const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  { id: 'n2', type: 'marketplace', title: 'New Arrivals', message: 'New furniture has arrived near your location from Urban Nest.', icon: 'shopping-bag', read: false, createdAt: '2024-06-15T09:15:00Z' },
